...
write.csv(store_matrix_table,paste0("Results/sen_power_beta2_n_",n,"_p_",p,"_m_",m,'_ck_',ck,".csv"),row.names=FALSE)
...
save.image(file=paste0("Results/sen_power_beta2_n_",n,"_p_",p,"_m_",m,'_ck_',ck,".RData"))
