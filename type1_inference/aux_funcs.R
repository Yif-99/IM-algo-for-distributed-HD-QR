...
ini_est <- function(lam_seq){
  clusterExport(cl7, list("beta_pre",'c0'))
...
sourceCpp('firsteig.cpp'); c0 = 0.5; G = 20; eta = rep(7.5,G) ; etag = rep(4,G) 
####################################################
