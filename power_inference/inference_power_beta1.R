...
et2=proc.time()[3]
write.csv(store_matrix_table,paste0("Results/power_beta1_n_",n,"_p_",p,"_m_",m,'_tau_',tau,".csv"),row.names=FALSE)
...
save.image(file=paste0("Results/power_beta1_n_",n,"_p_",p,"_m_",m,'_tau_',tau,".RData"))
